...
architecture Behavioral of Multiplier_5 is
  ...
  signal S_3_4, S_3_3, S_3_2, S_3_1, S_3_0 : std_logic;
  signal S_4_4, S_4_3, S_4_2, S_4_1, S_4_0 : std_logic;
  ...
  signal C_4_4, C_4_3, C_4_2, C_4_1, C_4_0 : std_logic;
  

  signal tempAnd : std_logic_vector(4 downto 0);
...
begin
  ...
  port map(
    ...
    tempAnd <= A and B;
    Z <= not (tempAnd(4) or tempAnd(3) or tempAnd(2) or tempAnd(1) or tempAnd(0));
    N <= A(4) xor B(4);

...
HD_PWD='C:/Users/Yutharsan/Documents/GitHub/CODD-Nano-Processor/project_AdvancedNano/project_AdvancedNano.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log Multiplier_5.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Multiplier_5.tcl -notrace
